...
let longText = 'Love is the best thing in this world. Some found their love and some are still looking for their love.';
console.log(longText.match("love"));//1
let longText2 = 'You cannot end a sentence with because because because is a conjunction';
console.log(longText2.match(/because/gi));//2
